...
import {BottomTabs, HomeScreen,InspectionDetails, TopNavigation,Step_1,Step_2,Step_3,Step_4,Step_5, WizardProgressBar, FormTopNavigation} from '../../export'
...
export default function StackNavigation() {
  return (
    ...
    >
      ...
      <Stack.Screen  name="formtopnavigation" component={FormTopNavigation} options={{headerShown:true,headerBackTitleVisible:false,headerTitle:'Information',headerStyle:{backgroundColor:THEME_COLOR},headerTitleStyle:{color:'white'}}} />
